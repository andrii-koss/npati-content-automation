(function () {
  ...
  async function listingForm() {
    ...
    const lockListingSwitch = (input, checked) => {
      input.checked = checked;
      input.tabIndex = -1;
      input.setAttribute("aria-disabled", "true");
      input.closest(".npati-switch-row")?.classList.add("is-locked");
    };
    lockListingSwitch(form.elements.disableBuy, true);
    lockListingSwitch(form.elements.shippingAvailable, false);
